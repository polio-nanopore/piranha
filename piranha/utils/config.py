...
KEY_MIN_HIGH_QUALITY_BASE = "min_high_quality_base"
KEY_MIN_BASE_QUALITY = "min_base_quality"
...
VALUE_MIN_BASE_QUALITY = 9
VALUE_MIN_HIGH_QUALITY_BASE = 10
VALUE_DEFAULT_MEDAKA_MODEL="r1041_e82_400bps_hac_variant_v4.3.0"
...
DETAILED_SAMPLE_COMPOSITION_TABLE_HEADER_FIELDS_ADDITIONAL = ["EPID","institute","gel","comments","qc_status"]
...
VALUE_CONFIGURATION_TABLE_FIELDS = [
                    KEY_MIN_READ_LENGTH,KEY_MAX_READ_LENGTH,KEY_MIN_MAP_QUALITY,KEY_MIN_BASE_QUALITY,KEY_MIN_HIGH_QUALITY_BASE,KEY_MIN_READS,KEY_MIN_ALN_BLOCK,
...
ISOLATE_DEFAULT_DICT = {
    KEY_REFERENCE_GROUP_FIELD:"isolate_group",
    KEY_RUNNAME:"polioISOLATE",
    KEY_MIN_READS:500,
    KEY_MIN_PCENT:0}
